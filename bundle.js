...
let url_icon = 'https://openweathermap.org/img/wn/' + weather.weather_icon + '@2x.png'
...
const displayWeatherData = () => {
    ...
    console.log('Wind Speed: ' + weather.windSpeed + 'm/s ' + degToCompass(weather.windDirection));
    console.log('Humidity: ' + weather.humidity + '%');
    console.log('Dew Point: ' + calcDuePoint(weather.temp_celsius, weather.humidity) + '°C');
...
let calcDuePoint = (temp, humi) => {
    let dewPoint =  Math.round(temp - (14.55 + 0.114 * temp) * (1 - (0.01 * humi)) - Math.pow(((2.5 + 0.007 * temp) * (1 - (0.01 * humi))),3) - (15.9 + 0.117 * temp) * Math.pow((1 - (0.01 * humi)), 14));
    return dewPoint;
}
